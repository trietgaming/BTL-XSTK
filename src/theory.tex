...
\small
\begin{tabular}{|p{3.5cm}|p{6.8cm}|p{3.2cm}|}
\hline
...
Ngoài thứ tự, còn có câu hỏi: \textit{có nên loại ngoại lệ sau khi phát hiện không?} Với dữ liệu phần cứng, GPU Quadro giá \$14.999 hay card workstation công suất 500W không phải sai số nhập liệu --- chúng tồn tại thực tế, nhưng thuộc \textbf{quần thể hoàn toàn khác}: phân khúc Workstation/Enterprise (Quadro, Tesla) được định giá theo chứng chỉ phần mềm ISV, bộ nhớ ECC và hỗ trợ doanh nghiệp B2B --- những yếu tố không có trong 8 biến phần cứng của bộ dữ liệu. Nếu giữ lại, mô hình bị ép giải thích khoảng giá \$23--\$14.999 chỉ từ thông số phần cứng không đủ, gây vi phạm giả định OLS và sai lệch dự đoán cho phân khúc người dùng phổ thông --- đúng mục tiêu đề tài. Do đó, nhóm quyết định \textbf{loại bỏ} các quan sát vượt ngưỡng Tukey ($> Q_3 + 1{,}5 \times \mathrm{IQR} = \$814$, tính trên tập thô), giới hạn phạm vi nghiên cứu trong phân khúc Consumer/Prosumer.
...
\node[box, below=of b3] (b4) {Bước 4: Loại NA, Intel, workstation\\(N=523) \& Điền khuyết Mode/Median};
...
\node[box, below=0.6cm of d1] (b71_test) {Chuyển đổi Log-Linear \&\\Lọc Residual Outliers};
